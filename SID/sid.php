...
MAJOR UPDATES ONLY:
    ...
    2.2.3 bw -- 2010-08-24 - Release with support for both SQLite and MySQL
                                includes support for multiple queries, triggers,
                                and example functions for SQLite
    2.2.8 bw -- 2012-01-26 - Added support for PostgreSQL
    2.5.1 bw -- 2013-11-30 - SQL EssT 2014 refresh
    2.6.9 bw -- 2014-03-27 - MySQL EssT 2014 refresh, includes support for
                                DELIMITER (for procedures) and many small bug fixes
...
define("MYSQLUSER", "sajib");
define("MYSQLPASS", "1120");
$db_list = array (
    '--NONE--',
    'scratch',
    'album',
